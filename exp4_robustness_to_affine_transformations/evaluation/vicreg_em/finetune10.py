...
def main_worker(gpu, args):
    ...
    criterion = EmRoutingLoss(finetune_1_percent_n_epochs).to(gpu)
    ...
    param_groups = [
        ...
        {'params': caps_net_fc_params, 'lr': 0.001}
    ]


    optimizer = optim.Adam(param_groups, 0, weight_decay=0)
