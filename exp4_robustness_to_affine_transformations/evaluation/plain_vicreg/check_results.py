...
def main_worker(gpu, args):
    ...
    checkpoint = torch.load("check_results_checkpoints/final_mnist_acc92_ckpt_epoch_5.pth.tar", map_location="cpu")
    ...
    checkpoint = torch.load("check_results_checkpoints/finetune_final_mnist_acc92_ckpt_epoch_12.pth.tar", map_location="cpu")
    model.load_state_dict(checkpoint['model_state'])
    model.cuda(gpu)
