...
def main_worker(gpu, args):
    ...
    checkpoint = torch.load("check_results_checkpoints/final_mnist_acc92_ckpt_epoch_11.pth.tar", map_location='cuda')  # or 'cpu'  
    ...
    checkpoint = torch.load("check_results_checkpoints/finetune_vicreg_linear_evaluation_after_pretrained_ckpt_epoch_7.pth.tar", map_location="cpu")
