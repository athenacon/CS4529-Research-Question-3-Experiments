...
if __name__ == "__main__":
    ...
    chpt = torch.load("pre_trained_model_epoch_1000.pth", map_location="cpu")
    model_state_dict = chpt['model_state_dict']
    ...
    optimizer = optim.SGD(head.parameters(), lr=0.0001, momentum=0.9, weight_decay=1e-6)
